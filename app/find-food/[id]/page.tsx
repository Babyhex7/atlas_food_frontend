...
export default function FoodDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col pb-10">
        ...
        <div className={cn(CONTAINER_CLASS, "relative z-[1]")}>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className={cn(
                ...
                isBookmarked ? "border-[1.5px] border-white/60 bg-white/20" : "border-[1.5px] border-white/30 bg-white/10"
              )}
            >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {food.local_name && (
                <p className="text-sm text-white/75 m-0 italic">
                  {food.local_name}
                </p>
              )}
            </div>
      ...
      <div className={cn(CONTAINER_CLASS, "-mt-8 relative z-10 flex-1 flex flex-col gap-5")}>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isEnergy ? "border-primary-border bg-primary-light" : "border-border bg-surface-alt"
                  )}
                >
                  <div className={cn("text-2xl font-bold font-mono leading-none mb-1", isEnergy ? "text-primary" : "text-text-primary")}>
                    {nutrient.value}
